...
const manifest = {
  ...
  prompt: ">",
  commands: ["/help", "/status", "/table", "/code", "/progress", "/download", "/error"],
  theme: {
    accent: "#58d6a8",
    accentMuted: "#4a9781",
    background: "#0d1117",
...
const commandHandlers = new Map([
  ...
  ["/status", () => ({
    ok: true,
    blocks: [
      { type: "status", label: "protocol", value: "v1", tone: "info" },
  ...
  ["/code", () => ({
    ok: true,
    blocks: [{ type: "code", language: "json", code: JSON.stringify({ promptkit: "v1", realtime: true }, null, 2) }],
  })],
  ["/progress", () => {
  ...
  ["/download", () => ({
    ...
    blocks: [{
      ...
      content: JSON.stringify({ generatedBy: "PromptKit", protocol: 1 }, null, 2),
